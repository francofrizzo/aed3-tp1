        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                \begin{axis}[
                    ...
                    \addplot[color=green] table[x index=0,y index=1]{../exp/kamehameha_caso_intermedio};
                    \addplot[color=blue] table[x index=0,y index=1]{../exp/kamehameha_caso_mejor};
                    % \addplot[color=red] table[x index=0, y expr={x*ln(x)*\constante}]{../exp/kamehameha_caso_peor};
                    \legend{$T$, $c*N^{N}$}
                \end{axis}
            \end{tikzpicture}
        \end{figure}
